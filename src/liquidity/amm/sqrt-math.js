...
export function getNextSqrtPrices (nextTick, sqrtPriceLimit, aToB) {
  const nextTickPrice = tickIndexToSqrtPriceX64(nextTick)
...
export function sqrtPriceX64ToTickIndex (sqrtPriceX64) {
  if (
